            ...
            <div className="glass-strong rounded-3xl shadow-premium-lg border border-rose/20 p-8 sm:p-12 hover:shadow-premium-lg hover:scale-[1.02] transition-all duration-500">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                {[
                  ...
                  { icon: <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>, title: 'Vendor Outreach', desc: 'We email and contact vendors for you - venues, catering, and more' }
                ].map((feature, i) => (
