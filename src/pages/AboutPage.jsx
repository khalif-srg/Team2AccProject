      ...
      <main className="relative z-10 flex-1 px-6 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            {/* Our Mission */}
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-wedding-blush/50 p-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-wedding-blush/50 p-8">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-wedding-coral shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-lg">Personalized recommendations based on your style and budget</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-wedding-coral shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-lg">Smart budget tracking and expense management</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-wedding-coral shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-lg">Curated vendor connections and verified reviews</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-wedding-coral shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-lg">Timeline management with automated reminders</span>
                </li>
              </ul>
            </div>
